...
function calculateFixedImageSizes({
  ...
  let aspectRatio = sourceMetadata.width / sourceMetadata.height; // make sure output outputPixelDensities has a value of 1
...
function calculateResponsiveImageSizes({
  ...
  let sizes = [];
  let aspectRatio = sourceMetadata.width / sourceMetadata.height; // Sort, dedupe and ensure there's a 1

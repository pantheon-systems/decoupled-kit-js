...
const apiEndpoint = 'https://dev-ds-demo.pantheonsite.io';
...
const recipesResourceDataResponseHandler = rest.get<typeof recipes>(
...
const recipesResourceData1ResponseHandler = rest.get<typeof recipes>(
...
const oauthTokenResponseHandler = rest.post<typeof recipes>(
